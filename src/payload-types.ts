...
export interface Education {
  id: number;
  /**
   * e.g. "Bachelor of Science (Information Systems)"
   */
  title: string;
  /**
   * e.g. "Singapore Management University"
   */
  institution: string;
  /**
...
export interface SiteSetting {
  ...
  /**
   * Tagline below the heading, e.g. "Software Engineer based in Singapore"
   */
  subtitle?: string | null;
  /**
   * Small circular avatar shown on the home page
   */
  profileImage?: (number | null) | Media;
  /**
   * Intro paragraph on the home page
   */
  bio?: string | null;
  /**
   * Link to your resume/CV file
   */
